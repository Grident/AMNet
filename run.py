...
from models.bert_model import AMNetREModel, AMNetNERModel
...
MODEL_CLASSES = {
    'MRE': AMNetREModel,
    'twitter15': AMNetNERModel,
    'twitter17': AMNetNERModel
}
...
def main():
    ...
    if args.dataset_name == 'MRE':  # RE task
        ...
        model = AMNetREModel(num_labels, tokenizer, args=args)
        ...
        model = AMNetNERModel(label_list, args)
